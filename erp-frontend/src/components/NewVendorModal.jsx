...
function NewVendorModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await apiClient.post('/scm/vendors', {
      ...
      const message =
        ...
        'Unable to create this vendor right now.'
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500">
              Add a supplier to the procurement network and make them available for new POs.
            </p>
          </div>
