...
function NewPricingRuleModal({ isOpen, onClose, onSuccess, products }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await apiClient.post('/crm/pricing-rules', {
      ...
      const message =
        ...
        'Unable to create pricing rule. Please try again.'
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500">
              Define a new quantity-based discount rule for the commercial team.
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="md:col-span-2">
              ...
              <input
                ...
                placeholder="Bulk discount for strategic accounts"
              />
            </div>
...
export default NewPricingRuleModal
